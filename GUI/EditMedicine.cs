...
namespace GUI
{
    public partial class EditMedicine : Form
    {
        ...
        public EditMedicine(string name)
        {
            InitializeComponent();
            this.name = name;
        ...
        {
            string text = BLL.MedicalSuppliesList.EditThuoc(txtName.Text, txtDVT.Text, txtQuantity.Text, txtPrice.Text, txtHamLuong.Text, txtNote.Text, txtType.Text);
